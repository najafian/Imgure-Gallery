...
class App extends React.Component<IProps> implements ILanguage {
  ...
  componentDidMount(): void {
    const languageWidget = this.iDropDownChangeLanguage.getWidget();
  ...
  render(): React.ReactElement | string | number | {} | React.ReactNodeArray | React.ReactPortal | boolean | null | undefined {
    ...
    return <div className="fullScreen-page-class" id="iScroll">
      ...
      <div className="page-footer-class"><Translate contentKey={'gallery.home.footer'}/></div>
    </div>;
  }
...
const mapStateToProps = ({locale,mainOperations}: IRootState) => ({
  locale,
  mainOperations
});
